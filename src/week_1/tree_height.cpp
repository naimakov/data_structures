...
void run_tests()
{
    std::string filename_base = std::string("/mnt/c/Users/naimakov/Desktop/edx/data_structures/starter_files/week1_basic_data_structures_starters/tree_height/tests/");
